...
[Phire_ii, Phirn_ii, bt2r, dgc] = great_circle_path(Phire, Phite, Phirn, Phitn, Re, dpnt);
    ...
    L0(count) = tl_p452_pdr(GHz, Tpc, dd, hh, hh, zz, Htg, Hrg, Phite, Phitn, Phire_ii, Phirn_ii, Gtx, Grx, pol, dct, dcr, press, temp, 0, tropo);
    L1(count) = tl_p452_pdr(GHz, Tpc, dd, hh, hh, zz, Htg, Hrg, Phite, Phitn, Phire_ii, Phirn_ii, Gtx, Grx, pol, dct, dcr, press, temp, 1, tropo);
